...
class Studente {
    ...
    public static void sortRecordsBySemesterAndCGPA(Studente[] students) {
    ...
    public static void sortRecordsByName(Studente[] students) {
        int n = students.length;
        for (int i = 0; i < n - 1; i++) {
            for (int j = 0; j < n - i - 1; j++) {
...
public class studento2 {
    public static void main(String[] args) {
        ...
        Studente.sortRecordsBySemesterAndCGPA(students);
        ...
        Studente.sortRecordsByName(students);
